...
class SearchUseCaseTest {
    ...
    fun `상의 필터 검색 테스트`() = runTest {
        ...
        useCase.search(searchKeyword, listOf(SearchFilter.CategoryFilter(listOf(), Category.Top)))
            .test {
    ...
    fun `드레스 필터 검색 테스트`() = runTest {
        ...
        useCase.search(searchKeyword, listOf(SearchFilter.CategoryFilter(listOf(), Category.Dress)))
            .test {
