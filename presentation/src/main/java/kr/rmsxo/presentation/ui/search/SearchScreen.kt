package kr.rmsxo.presentation.ui.search
...
import kr.rmsxo.presentation.ui.theme.Purple500
import kr.rmsxo.presentation.viewmodel.search.SearchViewModel
            ...
            items(filter.categories.size) { index ->
                ...
                Button(
                    ...
                    colors = ButtonDefaults.buttonColors(
                        backgroundColor = if (filter.selectedCategory == category) Purple500
                        else Purple200
                    )
                )
                {
