    ...
    Column {
        ...
        HorizontalPager(
            ...
            Column {
                RankingProductCard(
                    index * 3,
                    presentationVM.model.productList[index * 3], presentationVM
                ) { product ->
                    presentationVM.openRankingProduct(navHostController, product)
                }
                RankingProductCard(
                    index * 3 + 1,
                    presentationVM.model.productList[index * 3 + 1], presentationVM
                ) { product ->
                    presentationVM.openRankingProduct(navHostController, product)
                }
                RankingProductCard(
                    index * 3 + 2,
                    presentationVM.model.productList[index * 3 + 2], presentationVM
                ) { product ->
                    presentationVM.openRankingProduct(navHostController, product)
                }
            }
